...
export default function CreateListing() {
    ...
    const handleSubmit = async (event: React.FormEvent) => {
        ...
        const listingImageIds = await UploadFilesToServer('images/UploadListingImage', listingImages);
        ...
        const listing = {
            ...
            linkedImages: listingImageIds.map(result => result.id),
                ...
                <div className="py-8 px-12 space-y-8">
                    ...
                    >
                        <label className="w-full h-full flex justify-center items-center cursor-pointer">
                            ...
                            <input hidden type="file" id="file-input" multiple accept="image/*" onChange={onFileSelect}/>
                        </label>
                    </div>
