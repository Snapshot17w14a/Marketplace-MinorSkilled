...
export default function CreateUser(){
    ...
    return(
        <>
            <Button className="mt-8 ml-12 w-16 text-2xl" onClick={() => {fade(); setTimeout(() => history.back(), 500)}}>🡐</Button>
            ...
            <div className="flex justify-center-safe">
                <form className="flex flex-wrap basis-full justify-center-safe m-4" onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-between basis-full">
                        ...
                        <Button className="mx-8 py-2 px-4 my-4" type="button" onClick={() => {fade(); setTimeout(() => navigate("/account/login"), 500)}}>Log in</Button>
                    </div>
                </form>
            </div>
        </>
