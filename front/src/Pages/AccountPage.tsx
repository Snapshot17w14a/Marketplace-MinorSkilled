    ...
    return(
        <FadeContext.Provider value={fadeDiv}>
            <div className="flex place-content-center text-black dark:text-white h-screen font-[Sansation] ">
                <div className={`flex flex-wrap bg-neutral-300 dark:bg-neutral-800 rounded-lg self-center md:w-1/4 w-1/2 text-center drop-shadow-2xl drop-shadow-rose-500/50 transition-all
                        ${location.pathname === "/account/register" ? "h-1/2" : location.pathname === "/account/login" ? "h-96" : ""}
                    `}>
