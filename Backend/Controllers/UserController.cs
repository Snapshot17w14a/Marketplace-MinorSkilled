...
//        [HttpGet("{guid}")]
//        public async Task<ActionResult<User>> Get(Guid guid)
//        {
...
//                    PasswordHash = _passwordHasher.HashPassword(requestUser.Password),
//                };
...
//            if (user.PasswordHash != _passwordHasher.HashPassword(loginRequest.Password))
//                return Forbid();
...
//            try
//            {
//                var invalidRft = await _context.RefreshTokens.FirstOrDefaultAsync(rft => rft.UserId == user.Id);
